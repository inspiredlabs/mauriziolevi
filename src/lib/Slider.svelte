<script>
	let url = './images/Torres.del.Paine.National.Park.original.3288.jpg'
</script>

<!-- learn: feature image tachyons.io/components/articles/feature/index.html -->

<header class="athelas">
  <div class="vh-100 dt w-100 tc bg-dark-gray white cover" style="background:url({url}) no-repeat center;">
    <div class="dtc v-mid">
...
<!-- <article class="center measure-wide f5 pv5 lh-copy ph2">
