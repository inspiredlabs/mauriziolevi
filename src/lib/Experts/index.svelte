...
<Row bg="bg-white">
	<div class="highlight db black-70 f5 f4-ns f3-m f3-l lh-copy pv4 measure ph2 measure-ns ph4-ns measure-m ph2-m measure-wide-l ph0-l mr-auto ml-auto">
		<h4 class="mv0 pv4 f2 f2-ns f1-m f1-l fw2 lh-solid">
			...
			<span class="fraunces">I nostri</span><span class="fraunces-i">&nbsp;Esperti</span>
		</h4>

		<div class="flex justify-between w-100">
			<!-- inherit o-80 glow -->
			<!-- note: consider: `hooks.js` for website definitions -->
			...
			<a class="link inherit pointer transition hover-golden-brown o-80 w-10 w3-ns h3-ns w-10-m w3-l h3-l" href="https://za.pinterest.com/iviaggidimauriz/" title="Pintrest"><svg viewbox="0 0 16 16" class="no-select"><use xlink:href="#pintrest"></use></svg></a>
		</div>
	</div>
</Row>

<!-- <style>
.hover-golden-brown:active,
.hover-golden-brown:hover,
.hover-golden-brown:focus {
	color: var(--golden-brown);
}


.hover-bg-golden-brown:active,
.hover-bg-golden-brown:hover,
.hover-bg-golden-brown:focus {
  color: var(--golden-brown);
  fill: var(--golden-brown);
}
</style> -->