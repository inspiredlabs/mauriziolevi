...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    entry = "pages/__layout.svelte-cefaa6a3.js";
    js = ["pages/__layout.svelte-cefaa6a3.js", "chunks/index-da12b2a7.js"];
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    entry2 = "error.svelte-bd250297.js";
    js2 = ["error.svelte-bd250297.js", "chunks/index-da12b2a7.js"];
    css3 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_id_svelte();
    entry3 = "pages/_id_.svelte-7c30a4e8.js";
    js3 = ["pages/_id_.svelte-7c30a4e8.js", "chunks/index-da12b2a7.js"];
    css4 = [];
  }
});

// .svelte-kit/output/server/entries/endpoints/_id_.js
var id_exports = {};
__export(id_exports, {
  get: () => get
});
...
var Csp = class {
  constructor({ mode, directives }, { dev, prerender: prerender3, needs_nonce }) {
    ...
    __privateSet(this, _use_hashes, mode === "hash" || mode === "auto" && prerender3);
    ...
    routes: [
      {
        ...
        types: [null],
        path: null,
        shadow: () => Promise.resolve().then(() => (init_id(), id_exports)),
        a: [0, 2],
        b: [1]
      }
    ],
